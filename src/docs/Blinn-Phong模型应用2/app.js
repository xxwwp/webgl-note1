...
function main() {
  ...
  function render() {
    ...
    initVertexBuffers({ gl, vertexs, colors, perspective: mat, matNarmal, matModel: mat4Model });
 ...
 * }} param0
 */
function initVertexBuffers({ gl, vertexs, colors, perspective, matNarmal, matModel }) {
  // 绑定顶点
